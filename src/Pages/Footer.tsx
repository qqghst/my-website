        ...
        <section id='footer' className='bg-white pt-[140px] pb-[220px] flex flex-col justify-center'>
            <div className='container mx-auto flex justify-between items-center'>
                <div>
                    ...
                    <Button type='button'>
                        <span className='font-jetBrains bg-gradient-to-r bg-clip-text text-transparent from-black to-black hover:from-[#224078] hover:to-[#A42C7B]'>keep going?</span>
                        <img
                ...
                <div>
                <h2 className='text-[#262626] font-bold leading-[110%] tracking-bigText text-[20px] sm:text-[39.81px]'>KEEP IN TOUCH</h2>
                    <div>
                        <ul>
                            <li>

...
const Projects: React.FC = () => {
    return (
        ...
        // <section className='min-h-screen flex flex-col justify-around gap-[300px] mt-[150px]'>
        //     <div className='container mx-auto flex flex-col gap-[150px]'>
        //         <div>
        //             <a href="/" className='flex justify-around items-center flex-wrap'>
